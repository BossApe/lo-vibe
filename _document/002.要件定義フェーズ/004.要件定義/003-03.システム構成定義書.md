...
[前: 003-02.非機能要件定義書.md](003-02.非機能要件定義書.md) | [一覧](../README.md) | [次: 003-04.インターフェース定義書.md](003-04.インターフェース定義書.md)
...
Musuhi/
├── _document/          # ドキュメント群
├── _compose/           # Docker Compose 構成
│   ├── docker-compose.yml
│   └── docker-compose.override.yml  # ローカル開発用
├── musuhi-frontend/    # フロントエンド (SvelteKit)
│   └── src/
├── musuhi-api/         # バックエンド API (Go)
│   └── src/
├── tools/              # 補助スクリプト
...
- [003-02.非機能要件定義書](003-02.非機能要件定義書.md)
- [003-04.インターフェース定義書](003-04.インターフェース定義書.md)
