...
[前: 001-04.インターフェース定義書.md](001-04.インターフェース定義書.md) | [一覧](../README.md) | 次: なし
...
| --- | --- | --- | --- |
| プロジェクト | projects | プロジェクト情報 | FR-001 |
| セッション | sessions | プロンプトセッション | FR-002 |
| メッセージ | messages | プロンプトメッセージ（発話/応答） | FR-002 |
| 文書 | documents | Markdown 文書 | FR-003 |
| 文書履歴 | document_histories | 文書変更履歴 | FR-003 |
| タスク | tasks | aider・分析・レポートタスク | FR-004/FR-007/FR-008 |
| テンプレート | templates | AI 指示テンプレート | FR-006 |
