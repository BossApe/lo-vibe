...
| id | UUID | ○ | gen_random_uuid() | 主キー |
| project_id | UUID | ○ | — | プロジェクトID (FK: projects.id) |
| type | VARCHAR(32) | ○ | — | aider / doc_gen / report |
...
- 復旧手順書を整備し、Sprint 3 終了までにドリルを実施する
...
| 2026-05-05 | 0.4 | tasksテーブルtype列のlegacy_analyze削除・doc_gen追加（旧FR-008レガシー改修スコープ除外整合） | Copilot |
