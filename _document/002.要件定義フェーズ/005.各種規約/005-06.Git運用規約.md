...
- [6. Sprint 完了時の Git 操作](#6-sprint-完了時の-git-操作)
- [7. 禁止事項](#7-禁止事項)
- [8. 更新履歴](#8-更新履歴)
...
## 6. Sprint 完了時の Git 操作

各 Sprint 完了時に以下の手順を実施する。

```mermaid
flowchart TD
    A[Sprint 完了] --> B[develop の最終確認]
...
git tag -a v0.1.0 -m "Release v0.1.0: Sprint 1 完了"
