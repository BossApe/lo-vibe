...
前: [002-01.プロジェクト計画書](002-01.プロジェクト計画書.md) | [一覧](../README.md) | 次: [002-03.Phase-Sprint-Ticket分割基準](002-03.Phase-Sprint-Ticket分割基準.md)
...
| AC-008 | Phase/Sprint/Ticket 分割が完了し、GitHub Projects に登録される | 自動テスト |
...
| AC-012 | レトロスペクティブが記録され、次 Sprint タスクが Projects に登録される | 手動確認 |
...
- [002-03.Phase-Sprint-Ticket分割基準](002-03.Phase-Sprint-Ticket分割基準.md)
