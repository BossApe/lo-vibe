...
```mermaid
flowchart LR
    P1Infra["Phase 1 のインフラ構成\n（変更なし）"]
    MusuhiV2["Musuhi App v2\n・自動レポート生成エンジン追加\n・UI/UX 改善\n・性能最適化"]
...
flowchart TD
    subgraph P0["Phase 0 完了時"]
        P0F["✅ プロジェクト作成・一覧\n✅ プロンプトログ保存・再表示\n✅ Markdown 文書管理\n✅ aider 基本連携"]
        P0I["🖥️ Traefik + Musuhi + Forgejo\n+ LiteLLM + Ollama + aider + PostgreSQL"]
    end

    subgraph P1["Phase 1 完了時（追加分）"]
        P1F["✅ 進捗可視化ダッシュボード\n✅ AI 指示テンプレート\n✅ レガシー改修支援\n✅ テスト・Coverage 可視化\n✅ IaC テンプレート生成"]
        P1I["🆕 Qdrant + Garage + Open WebUI\n+ SearXNG + 監視基盤\n（Prometheus / Grafana / Loki）"]
    end

    subgraph P2["Phase 2 完了時（追加分）"]
        P2F["✅ 自動進捗レポート生成・エクスポート\n✅ UI/UX 改善・性能最適化"]
        P2I["🔧 インフラ変更なし\nMusuhi App のみ更新"]
    end
